...
namespace SysParking.Net.Controllers
{
    public class CarroesController : Controller
    {
        ...
        public CarroesController(SysParkingNetContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Carro != null ? 
                          ...
                          Problem("Entity set 'SysParkingNetContext.Carro'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Marca,Modelo,Cor,Placa")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Marca,Modelo,Cor,Placa")] Carro carro)
        {
            if (id != carro.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SysParkingNetContext.Carro'  is null.");
            }
            var carro = await _context.Carro.FindAsync(id);
            if (carro != null)
            {
